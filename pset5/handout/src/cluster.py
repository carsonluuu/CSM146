...
class Cluster(object) :
    ...
    def centroid(self) :
        ...
        centroid_label, count = stats.mode(labels)
        
        centroid = Point('centroid', centroid_label, centroid_attrs)
        return centroid
        ### ========== TODO : END ========== ###
    ...
    def medoid(self) :
        ...
        for p in self.points:
            ...
            avg = total_dist/num_points
            avg_dist.append(avg)
            
        index_min_avg_dist = np.argmin(avg_dist)
        medoid = Point('medoid', self.points[index_min_avg_dist].label,
                       self.points[index_min_avg_dist].attrs)
        return medoid
        ### ========== TODO : END ========== ###
