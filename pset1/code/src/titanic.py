...
#            cross_val.append(cross_val_score(knn_clf, X, y, cv=10, scoring='accuracy').mean());
#    best_k_knn = plt.scatter(ks, cross_val, c='c', s=35)
#    plt.suptitle('The Effect of k for KNN on Validation Error', fontsize=20)
...
#    plt.ylabel('Accuarcy', fontsize=16)
    ...
    # Make plot
    train_scatter = plt.scatter(depths, training_errors, c='m', s=35)
...
#    random_scatter = plt.plot((0, 20), (0.48657342657342667, 0.48657342657342667), 'b')
    plt.suptitle('Decision Tree Depths VS Error', fontsize=20)
...
#    
#    train_scatter_tree = plt.scatter(sizes, best_training_errors_tree, c='c', s=35)
#    test_scatter_tree  = plt.scatter(sizes, best_test_errors_tree, c='r', s=35)
#    
#    train_scatter_knn = plt.scatter(sizes, best_training_errors_knn, c='b', s=35)
#    test_scatter_knn  = plt.scatter(sizes, best_test_errors_knn, c='m', s=35)
#    
#    plt.suptitle('Decision Tree Training Set Size Affect on Error', fontsize=20)
#    plt.xlabel('training data size', fontsize=18)
#    plt.ylabel('error', fontsize=16)
#    plt.legend((train_scatter_tree, test_scatter_tree, train_scatter_knn, test_scatter_knn),
#               ('Decision tree training data', 'Decision tree testing data', \
#                'KNN training data', 'KNN testing data',),
#               scatterpoints=1,
#               loc='lower right',
#               ncol=3,
#               fontsize=9)
